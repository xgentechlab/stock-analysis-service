...
def get_filtered_stocks(metrics: List[Dict[str, Any]], min_momentum_pct: float, min_volume_spike: float, require_institutional: bool, max_pe_ratio: float, min_roe: float, min_market_cap_cr: float) -> bool:
    ...
    roe = enhanced_fundamentals.get("roe") or basic_fundamentals.get("roe")
